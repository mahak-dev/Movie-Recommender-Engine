...
with st.container():
    ...
    with left_column:
        ...
        st.markdown("""<form>
  <button formaction="https://mrs-engine.herokuapp.com">Movie Recommendation Engine</button>
...
with st.container():
    ...
    with right_column:
        ...
        st.markdown("""<form>
            <button formaction="https://drive.google.com/file/d/14u34PGtUnIo0y1mzubZEfzORlgBHgOl3/view">Here is the Documentation</button>
                </form>""", unsafe_allow_html=True)
...
with st.container():
    ...
    with image_column:
        st.image(img_ss1)
    with text_column:
        st.subheader("Recommender Engine Github Repo")
        st.write(
            """
        ...
        st.markdown("""<form>
  <button formaction="https://github.com/mahak-dev/Movie-Recommender-Engine">Github Repo</button>
</form>""", unsafe_allow_html=True)
...
with st.container():
    ...
    with image_column:
        ...
        st.markdown("""<form>
  <button formaction="https://youtu.be/-fiXxeUYcGc">Demo Video</button>
</form>""", unsafe_allow_html=True)
...
with st.container():
    ...
    with col1:
        st_lottie(lottie_github,height=130, key="social-github")
        st.markdown("""<form>
  <button formaction="https://github.com/mahak-dev">Github</button>
</form>""", unsafe_allow_html=True)
        
    with col2:
        st_lottie(lottie_mail,height=130, key="social-mail")
        st.markdown("""<form>
  <button formaction="mailto:guptamahak740@gmail.com">Email</button>
</form>""", unsafe_allow_html=True)
    with col3:
        st_lottie(lottie_linkedin,height=130, key="social-linkedin")
        st.markdown("""<form>
  <button formaction="https://www.linkedin.com/in/mahak-gupta-60197a1aa/">Linkedin</button>
</form>""", unsafe_allow_html=True)
    with col4:
        st_lottie(lottie_whatsapp,height=130, key="social-whatsapp")
        st.markdown("""<form>
  <button formaction="https://wa.me/+916268263887">Whatsapp</button>
</form>""", unsafe_allow_html=True)
